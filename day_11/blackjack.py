...
def compare(user_score, computer_score):
    if user_score == computer_score:
        ...
        return "Won, your opponent went over"
...
def playgame():
    ...
    while not is_game_over: 
        ...
        print(f"Computer's first card is{computer_cards[0]} and its score is {computer_score}")
    ...
    print(f"Computer's final cards are {computer_cards} and its score is {computer_score}")
    print(result)
