...
if direction == "left":
    ...
    if step2 == "wait":
        #continue
        door = input("You arrive at the island unharmed. There is a house with three doors. One red, one yellow and one blue. Which color do you choose? ").lower()
        ...
        if door == "red":
            ...
            print("It is a room full of beats. Game Over!")
        else:
